...
import (
	...
	"kube-watcher/cli/pkg/middleware"
...
func setupMiddleware() {
	...
	mwChain := middleware.Chain(
		...
		middleware.NewErrorHandlerMiddleware(middleware.DefaultErrorHandlerConfig()),
		middleware.PanicRecoveryMiddleware(),
		middleware.NewKubeConfigMiddleware(middleware.DefaultKubeConfigMiddlewareConfig()),
	)

	// Apply middleware to root command
	middleware.ApplyToCommand(rootCmd, mwChain)
}
