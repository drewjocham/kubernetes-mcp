...
func (t *PodResourcesTool) analyzePod(pod kubernetes.PodInfo, threshold int) PodIssueAnalysis {
	var issues []string
...
func (t *PodResourcesTool) mapContainers(containers []kubernetes.ContainerInfo) []map[string]interface{} {
