declare global {
  ...
  const createAlert: typeof import('../../server/utils/alert-store').createAlert
  ...
  const getWorkflowConfig: typeof import('../../server/utils/alert-store').getWorkflowConfig
  ...
  const pushThinkingStep: typeof import('../../server/utils/alert-store').pushThinkingStep
  ...
  const runWorkflow: typeof import('../../server/utils/workflow').runWorkflow
  ...
  const setFailed: typeof import('../../server/utils/alert-store').setFailed
  const setHeader: typeof import('../../node_modules/h3').setHeader
  const setHeaders: typeof import('../../node_modules/h3').setHeaders
  const setReport: typeof import('../../server/utils/alert-store').setReport
  const setResponseHeader: typeof import('../../node_modules/h3').setResponseHeader
  const setResponseHeaders: typeof import('../../node_modules/h3').setResponseHeaders
  const setResponseStatus: typeof import('../../node_modules/h3').setResponseStatus
  const setThinking: typeof import('../../server/utils/alert-store').setThinking
  const setWorkflowConfig: typeof import('../../server/utils/alert-store').setWorkflowConfig
